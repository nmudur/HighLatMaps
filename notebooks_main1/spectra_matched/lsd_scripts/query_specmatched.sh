...
#SBATCH -p test
#SBATCH --mem=40000
#SBATCH -o logs/specmatch_query_%j.o
#SBATCH -e logs/specmatch_query_%j.e
...
lsd-query --format=fits --output=spectrain_2_11_r50.fits --bounds='beam(0, 90, 50, coordsys="gal")' "$OPTIONS"