...
echo "Inputfilenum $INPFILENUM"
fn=$(printf "north.%05d.h5" ${INPFILENUM}) || exit 1 #EDIT
echo "Filenum $fn"
inputdir=/n/holylfs05/LABS/finkbeiner_lab/Lab/nmudur/bayestar_edr3/input_fullsky/north/ #EDIT
inputfile=${inputdir}/${fn}
gridfile=/n/holylfs05/LABS/finkbeiner_lab/Lab/nmudur/bayestar_edr3/output_fullsky/north/${fn} #EDIT
...
bash /n/holylfs05/LABS/finkbeiner_lab/Lab/nmudur/bayestar_edr3/compute_append_gmm.sh ${gridfile} ${postprocfile} "delete"
